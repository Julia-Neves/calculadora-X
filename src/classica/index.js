const containerCalculadoraCassica = document.createElement("div");
containerCalculadoraCassica.id = "div__container__classica";

function calculadoraClassicaFactorie() {
  const calculadora = {
    container: containerCalculadoraCassica,
    content: `
      <div id="visor">
      <p id="input"></p>
      <div id="container">
  ...
  calculadora.container.innerHTML = calculadora.content;
